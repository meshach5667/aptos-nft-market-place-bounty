  ...
  const handleFetchNfts = async (selectedRarity: number | undefined) => {
    try {
      const response = await client.getAccountResource(
        marketplaceAddr,
        "0x1630fd1f7f0c18995b46c243eaaa8ab04e9a919dae2d2ea94acff2825f0d9014::NFTMarketplace::Marketplace"
      );
  ...
  return (
    ...
    >
      ...
      >
        {selectedNft && (
          <div>
            <img alt={selectedNft.name} src={selectedNft.uri} style={{ width: "100%" }} />
